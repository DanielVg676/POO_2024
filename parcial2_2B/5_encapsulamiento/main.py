...
# Aqui no importa por que es un atributo publico y se puede utilizar asi
coche1.publico_atributo

print(coche1.publico_atributo)

# ESTO NO ES PERMITIDO YA QUE ES UN ATRIBUTO PRIVADO

# print(coche1.privado_atributo)

# Esto si

print(coche1.getPrivado_atributo())
